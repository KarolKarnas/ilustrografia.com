...
const ContactPage = () => {
  return (
    <>
      <Meta title="Contact · Ilustrografia · Illustration · Digital Painting · Fantasy · Legends" />
      ...
      <div className="relative flex w-11/12 flex-col items-center justify-center md:flex-row md:gap-20">
        ...
        <div className="flex w-full justify-start  md:w-1/2">
          <MainTitlesWrapper>
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-2 md:mt-16">
