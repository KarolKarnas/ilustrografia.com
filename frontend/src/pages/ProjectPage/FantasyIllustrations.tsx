...
const FantasyIllustrations = () => {
  ...
  return (
    <>
      <Meta title="Project · Fantasy Illustrations · Ilustrografia · Illustration · Digital Painting · Fantasy · Legends" />
      ...
      <div className="flex w-11/12 flex-col items-center justify-center">
            ...
            <div className="z-10 mb-8 mt-12 flex w-10/12 flex-col items-center justify-center md:w-1/3">
              ...
              <p className="flex flex-col items-center justify-center gap-5  text-center  font-cormorant-infant text-xl font-semibold italic text-eerie-black drop-shadow-lg dark:text-ivory">
                <span>
                  ...
                  ancient guardians and the sea&apos;s rhythmic waves dance
                  against rugged cliffs. Discover hidden treasures and mythical
        ...
        <div className="my-6 flex w-full flex-col items-center justify-center font-light md:my-16 md:w-7/12 xl:w-6/12">
          ...
          <p className="mb-4 block w-11/12 text-center dark:text-ivory sm:w-1/2 ">
            We are delighted that you&apos;re here! Allow us to introduce you to
            a realm brimming with magic and passion. This realm is our
            imagination - devoted entirely to the canon of fantasy. It manifests
            itself in the form of illustrations, which have been created for
            many years.
          </p>{" "}
          <p className="mb-4 block w-11/12 text-center dark:text-ivory sm:w-1/2  ">
