...
const NeoSlavicCensus = () => {
  ...
  return (
    <>
      <Meta title="Project · Neo-slavic Census · Ilustrografia · Illustration · Digital Painting · Fantasy · Legends" />
      <div className="flex w-11/12 flex-col items-center justify-center">
        <section className="relative flex flex-col items-center justify-center">
          <div className=" fixed -left-[23rem] top-[5rem] -z-10 hidden w-1/2 md:flex md:items-center md:justify-center  ">
            <ImageMouseMoving
            ...
            <div className="z-10 mb-8 mt-12 flex w-10/12 flex-col items-center justify-center md:w-1/3">
              <p className="flex flex-col items-center justify-center gap-4  text-center  font-cormorant-infant text-xl font-semibold italic text-eerie-black drop-shadow-lg dark:text-ivory">
                <span>
                  ...
                  majestic presence awe-inspiring, much like they did for our
                  forefathers. The rhythmic roar of the Baltic Sea waves, as
                  they crash with foamy grace against rugged cliffs, carries an
                  ageless and unwavering melody.
                </span>
        ...
        <div className="my-6 flex w-full flex-col items-center justify-center font-light md:my-16 md:w-7/12 xl:w-6/12">
          ...
          <p className="block dark:text-ivory ">
            ...
            behind their fences, living by the cycle of day and night, spring
            and winter, have expanded, grown upward, and harnessed the laws of
            Nature. Now, not only do rivers rush toward the sea, forming the
            arteries of these lands, but they are also adorned with the black
            veins of solidified roads, which have interlinked into a network and
            diminished the world. Heavy machines, lifeless creatures obedient to
            human will, speed along them. And the sky? It appears almost the
            same. The night is adorned with unchanging stars and the wandering
            moon on the same path. The day is still azure as before, and
            variously shaped clouds roll across its surface. However, the
            firmament no longer belongs solely to winged beings who jealously
            guarded the gift of flight. Humans have detached themselves from the
            earth, ascended, and laid claim to the celestial vault as well.
          </p>
          ...
          <p className="flex flex-col justify-center gap-3 dark:text-ivory">
            <span>
              ...
              an has become fearless. He is the ruler of these lands. The
              harshest winters no longer daunt him, nor do scorching summer
              heatwaves. He effortlessly dispels the darkness of night and has
              the power to overshadow the brightness of noon. He reigns over all
              the wildlife and rules over nature with an iron-fisted tyranny.
              How greatly this man has spread his dominion! To such an extent
              that it would seem he has ceased to notice his fellow inhabitants
              of Mother Earth. And I am not only speaking of our lesser
              brethren. For once-wild, formidable, and numerous animals are no
              longer as wild or formidable, and their numbers have dwindled,
              confined to uninhabited lands and protected reserves of the Slavic
              realm. But we will not speak of them here. We will speak of other
              beings, those whom no one has cared for in a long time, those who
              bear many names, and of whom most Slavs no longer wish to take
              notice.
            </span>
          ...
          <p className="flex flex-col justify-center gap-3 dark:text-ivory">
            <span>
              ...
              bout entities, figures, rascals, and reprobates. About the good
              and kind, and those morally twisted. About the predatory and
              swift, and those airborne and mischievous. And about those from
              the otherworld, companions of the diabolic. And about those
              without form or life, yet eager to exist. About the fiery and
              scorching, and the beautiful and enticing. About the uglies that
              frighten, and the troubles they foretell. About the manifold,
              diverse, of all kinds and sorts. As large as oaks that like to
              bite. Or those as small as little mice. Or altogether entirely
              invisible.
            </span>
          </p>
          <div className="py-8 text-center">
          ...
          <p className="flex flex-col justify-center gap-3 dark:text-ivory">
            <span>
              ...
              es, dear Slavs. Once upon a time, countless stories were told
              about them. In ancient times, bestiaries were eagerly filled with
              ...
              life, death, eternal rebirth, and daily problems. And so, with
              sweat on our brows, labor, and toil, the New Slavic Census is
              being created. A trio of amateur researchers, inspired scientists,
              full of passion and vigor, has decided to take a closer look at
              those who still dwell on these lands with us. It won&apos;t be an
              easy task; there is much work ahead of us. But with your
              invaluable help and support, we will discover and get to know all
              those whom the darkness of oblivion has shrouded. Let&apos;s get
              to work!
            </span>
          </p>
          <img
