...
const HomePage = () => {
  ...
  return (
    <>
      <Meta title="Home · Ilustrografia · Illustration · Digital Painting · Fantasy · Legends" />
      <div className=" flex w-full flex-col gap-y-20 p-2 md:w-11/12 md:p-0">
        <div
          className=" md:h-196
       flex h-screen flex-col items-center  justify-center rounded-3xl bg-hero bg-cover bg-center bg-no-repeat shadow-hero lg:h-224"
        ...
        <div className="flex">
          ...
          <div className="flex w-full flex-col items-center justify-center px-2 md:w-2/4">
            ...
            <strong className=" mb-5 text-center text-eerie-black dark:text-ivory">
              No doubt you&apos;re pondering what extraordinary place
              you&apos;ve stumbled upon, aren&apos;t you?{" "}
            </strong>
            ...
            <strong className="text-center font-cormorant-infant text-2xl font-semibold italic text-eerie-black  drop-shadow-red-heading dark:text-ivory dark:drop-shadow-lg md:text-3xl">
        ...
        <SectionMain>
          <MainTitlesWrapper>
            ...
            <div className="  flex w-full flex-col items-center gap-4 rounded-xl bg-black bg-opacity-30 px-8 py-10 md:px-20">
              <MainText alwaysLight>
