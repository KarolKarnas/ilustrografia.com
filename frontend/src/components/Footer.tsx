...
const Footer = () => {
  return (
    <footer className=" dark:bg-black-magic  flex flex-col justify-center items-center gap-20 md:gap-0 md:flex-row  w-full md:items-start md:justify-evenly  bg-ivory py-16   shadow-2xl dark:shadow-red-magic transition-colors    duration-500 dark:text-ivory">
