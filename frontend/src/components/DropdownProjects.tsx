    ...
    <DropdownMenu.Root>
      ...
      <DropdownMenu.Portal>
        <DropdownMenu.Content
          side="bottom"
          className="DropdownMenuContent dark:bg-bg-black-magic/50 mt-2 flex w-64 flex-col gap-2 border border-red-magic/50  bg-ivory p-4 text-sm font-semibold uppercase text-eerie-black shadow-hero backdrop-blur-sm  dark:bg-black-magic dark:text-ivory z-50"
        ...
        >
          ...
          <Link to="/projects/fantasy-illustrations" className="mx-auto" >
            <DropdownMenu.Item
              className="drop-shadow-xl transition duration-500 hover:scale-110 hover:cursor-pointer hover:text-red-magic hover:outline-none    focus:scale-110 focus:text-red-magic focus:outline-none "
            >
