...
const ReviewEditForm = ({
  ...
  return (
    <div className="bg-ivory dark:bg-eerie-black p-4 md:p-8 rounded-lg shadow-md">
      {/* md:w-9/12 lg:w-6/12 2xl:w-1/3 */}
      <Form.Root className="flex w-full flex-col lg:flex-row items-center gap-1 md:gap-5 ">
        <div
              ...
              <Select.Viewport className=" w-20 rounded-md border border-red-magic/50 bg-white text-black-magic shadow-lg dark:bg-black-magic">
                <Select.Group>
                  {Array.from({ length: 5 }, (_, index) => (
                    <Select.Item
                      className={` ${
                        index === 5 - 1 ? "" : "border-b border-b-red-magic/50"
