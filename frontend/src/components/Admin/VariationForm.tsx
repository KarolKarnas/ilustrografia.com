...
import VariationEdit from "./VariationEditForm";
              ...
              />{" "} */}
                ...
                <div className="flex items-center gap-2">
                  ...
                  onClick={() => handleDeleteVariation(index)}
                              /> */}
                  <VariationEdit price={variation.price} countInStock={variation.countInStock} setVariations={setVariations} sku={variation.SKU} index={index} variations={variations}/>
                </div>
              </div>
            </div>
          ))}
